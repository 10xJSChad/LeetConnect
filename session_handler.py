import time
import pickle
import website_definitions #Nothing from here is used, just initializing it.

from selenium import webdriver
from selenium.webdriver.chrome.service import Service as ChromeService
from classes import WebsiteDefinition, WebDriver
...
def get_existing_session(return_everything=False) -> WebDriver | \
                            tuple[WebDriver, WebsiteDefinition, int]:
